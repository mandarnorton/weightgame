...
#Read in POP TIF 
global_pop_23 <- raster("/Users/amandanorton/Desktop/Final Rasters/rast_log.tif")
...
climate_data <- extract_nc_value(first_year = 2011, 
                                 last_year = 2023,
                                 local_file = TRUE,
                                 file_path = '/Users/amandanorton/Desktop/tx_ens_mean_0_1deg_reg_2011_2023_v280e.nc',
                                 sml_chunk = "2011-2023",
...
names(NUTS_3b)<-c('NUTSID','LEVL','CNTR','NAME_LATIN','NAME','MOUNT','URBN','COAST','FID','geo','Temp_wgtlog','Date')
...
#Export to csv 
write.csv(NUTS_3b_dfa, file = '/Users/amandanorton/Desktop/temp_wgtavglog_2023.csv')
remove(NUTS_3b)
