...
#Read in POP TIF 
global_pop_23 <- raster("/Users/amandanorton/Desktop/Final Rasters/aged65pls.tif")
...
#Export to csv 
write.csv(NUTS_3b_dfa, file = '/Users/amandanorton/Desktop/temp_wgtavg60pls_2023.csv')
remove(NUTS_3b)
